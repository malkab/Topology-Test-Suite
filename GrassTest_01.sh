...
# ----------------------
# Test with heavy layers
# ----------------------

# Data import
g.mapset mapset=aux
v.in.ogr dsn=$prefix/InputShapes output=mun layer=municipios_sevilla --overwrite
v.in.ogr dsn=$prefix/InputShapes output=usos layer=usos --overwrite
v.clean in=mun out=mun_clean error=mun_error tool=prune thresh=250 --overwrite 
